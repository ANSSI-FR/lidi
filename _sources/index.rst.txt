...
Lidi (leedee) allows you to copy TCP/UDP/Unix streams (or files) over a unidirectional link.
...
Lidi has been developed to answer a specific need: copy TCP/UDP/Unix streams (or files) across a unidirectional link fast and reliably.
